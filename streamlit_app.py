...
genai.configure(api_key="AIzaSyBmrlp3E9EHY393Kh_wU__Pu6uPafK7jls") 
...
st.set_page_config(page_title="Pravanths invoice generator")
st.sidebar.header("Invoice Generator")
st.sidebar.write("Made by Pravanth S")
st.sidebar.write("Assistant used is Gemini PRO Vision.")
st.header("Invoice Generator")
st.subheader("Manage your expenses with the help of Invoice Generator!")
...
At the end, make sure to repeat the name of our app "Invoice Generator " and ask the user to use it again.
"""
